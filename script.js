...
// Check/Initialise the local storage
...
//Function to check whether a particular element is in Favourite list
...
//Event listener to toggle button for showing favourite meal list
...
//Function adds toggle button functionality
...
//Function fetches data, then creates HTML structure for meals
        ...
        html = mealsData.meals.map(element => {
            ...
            <div class="card-top"  onclick="showMealDetails(${element.idMeal}, '${inputValue}')">
                ...
                <div class="dish-details">
                    ...
                    <span class="button" onclick="showMealDetails(${element.idMeal}, '${inputValue}')">More...</span>
...
//Function to add/remove a meal from favourites List. It first checks for presence of the element-> if present it removes the element, if not present it adds the element
...
//Shows details of selected meal, appears on top when a meal is selected/clicked.
        ...
        html += mealList.meals.map(element => {
            ...
            <div class="card">
                <div class="card-top"  onclick="showMealDetails(${element.idMeal}, '${searchInput}')">
                    ...
                    <div class="dish-details">
                        ${truncate(element.strInstructions, 50)}
                        <span class="button" onclick="showMealDetails(${element.idMeal}, '${searchInput}')">More...</span>
                    </div>
                </div>
                <div class="card-bottom">
                    <div class="like">
...
//Function to show/update favourite list, one shown by clicking hamburger menu.
